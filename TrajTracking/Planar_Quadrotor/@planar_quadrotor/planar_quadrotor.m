classdef planar_quadrotor < handle
    ...
    methods
        ...
        function xd = Dynamics(obj, t, q, u)
            ...
            ddx = -(1 / obj.m) * (u(1) + u(2)) * sin(theta) - 0.05 * q(1)^2 / obj.m;
...
%                 obj.draw_circle(xi,yi);
        ...
        function [] = draw_rotor(obj, x, y, theta)
            ...
            scatter(rotor_L_x, rotor_L_y,'LineWidth',1.0,'MarkerFaceColor','b','MarkerEdgeColor','b',...
                    'MarkerFaceAlpha',0.3); 
            hold on;
            scatter(rotor_R_x, rotor_R_y,'LineWidth',1.0,'MarkerFaceColor','b','MarkerEdgeColor','b',...
                    'MarkerFaceAlpha',0.3); 
            hold on;
        end
