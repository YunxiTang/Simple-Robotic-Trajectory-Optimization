...
%                 plot(params.xref{1}(1,1), params.xref{1}(2,1), 'kp', 'MarkerFaceColor', 'b', 'MarkerSize', 15); hold on;
%                 plot(params.xf(1), params.xf(2), 'rh', 'MarkerFaceColor', 'r', 'MarkerSize', 15); hold on;
        ...
        function [J_idx,xsol,usol] = simulate_phase(obj,rbt,cst,params,idx,x0,xbar,ubar,du,K)
            ...
            for i=1:(obj.L-1)
                ...
                J_idx = J_idx + cst.l_cost(xi, ui, xrefi, urefi) + obj.Constraint.AL_Term(xi, ui, lambda, Imu);
                % Propagate dynamics
            ...
            if idx==obj.M
                ...
                J_idx = J_idx + cst.lf_cost(xsol(:,end),xref(:,end)) + obj.Constraint.AL_Term(xN, zeros(params.nu), lambdaN, ImuN);
            end
        ...
        function [dV,Vx,Vxx,du,K,success] = BackwardPass(obj,rbt,cst,xbar,ubar,dft,params)
            ...
            for i = (obj.M):-1:1
                ...
                for j = (obj.L-1):-1:1
                    ...
                    Vx_ij = Vx{i}(:,j+1);
                    Vxx_ij = Vxx{i}(:,:,j+1);
                    [Qx,Qu,Qxx,Quu,Qux,Qxu,Quu_hat,Qux_hat] = cst.Qcms_info(rbt,cst,obj.Constraint,lambda_ij,Imu_ij,x_ij,u_ij,xref_ij,uref_ij,Vx_ij,Vxx_ij,params,obj.iter);
                    % regularization
