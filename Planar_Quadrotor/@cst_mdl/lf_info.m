...
t2 = x2-1.0;
t3 = t2.*2.5e+1;
lf = t2.*t3+(x1.*2.5e+1-4.25e+2./2.0).*(x1-1.7e+1./2.0)+x3.^2.*2.5e+1+x4.^2.*2.5e+1+x5.^2.*2.5e+1+x6.^2.*2.5e+1;
if nargout > 1
    lfx = [x1.*5.0e+1-4.25e+2,t2.*5.0e+1,x3.*5.0e+1,x4.*5.0e+1,x5.*5.0e+1,x6.*5.0e+1];
end
if nargout > 2
