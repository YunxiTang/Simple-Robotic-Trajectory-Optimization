classdef cst_mdl < handle
    ...
    methods (Static)
       ...
       [Qx,Qu,Qxx,Quu,Qux,Qxu,Quu_hat,Qux_hat] = Q_info(rbt,cst,x,u,Vx,Vxx,params,iter);
       [Qx,Qu,Qxx,Quu,Qux,Qxu,Quu_hat,Qux_hat] = Qcs_info(rbt,cst,x,u,xref,uref,Vx,Vxx,params,cons,V_reg)
    end
end
