...
x6 = in1(6,:);
t2 = x1-1.0;
lf = t2.*(x1.*(5.0./2.0)-5.0./2.0)+(x2.*(5.0./2.0)-1.5e+1./4.0).*(x2-3.0./2.0)+x3.^2.*(5.0./2.0)+x4.^2.*(5.0./2.0)+x5.^2.*(5.0./2.0)+x6.^2.*(5.0./2.0);
if nargout > 1
    lfx = [t2.*5.0;x2.*5.0-1.5e+1./2.0;x3.*5.0;x4.*5.0;x5.*5.0;x6.*5.0];
end
if nargout > 2
