...
x3 = in1(3,:);
x4 = in1(4,:);
l = ((x1./2.0-1.0).*(x1-2.0))./1.0e+2+((x2./2.0-1.0).*(x2-2.0))./1.0e+2+((x3-pi./2.0).*(x3./2.0-pi./4.0))./1.0e+2+u1.^2./2.0e+3+u2.^2./2.0e+3+x4.^2./2.0e+2;
if nargout > 1
    lx = [x1./1.0e+2-1.0./5.0e+1;x2./1.0e+2-1.0./5.0e+1;x3./1.0e+2-pi./2.0e+2;x4./1.0e+2];
end
if nargout > 2
