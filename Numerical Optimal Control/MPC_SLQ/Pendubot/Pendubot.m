classdef Pendubot < Robot
    ...
    methods
        ...
        function dxdt = uncertain_Dynamics(obj, t, x, u)
            dq = x(3:4,:);
            [M,C,G,F,B] = obj.Sim_EoM(x);
            M = 1.05 * M;
            F = 0.95 * F;
        ...
        function x_next = uncertain_rk45(obj, x, u, dt)
            % rk45 integration with full dynamics
            k1 = obj.uncertain_Dynamics(0, x,            u);
            k2 = obj.uncertain_Dynamics(0, x + 0.5*dt*k1,u);
            k3 = obj.uncertain_Dynamics(0, x + 0.5*dt*k2,u);
            k4 = obj.uncertain_Dynamics(0, x + dt*k3,    u);
            x_next = x + dt/6*(k1+2*k2+2*k3+k4);
        end
