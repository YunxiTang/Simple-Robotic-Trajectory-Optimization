...
M20 = load('M_20_23-Mar-2021.mat');      S20 = M20.J_hist;   L20 = length(S20);
M25 = load('M_25_23-Mar-2021.mat');      S25 = M25.J_hist;   L25 = length(S25);
M50 = load('M_50_23-Mar-2021.mat');      S50 = M50.J_hist;   L50 = length(S50);
M100 = load('M_100_23-Mar-2021.mat');    S100 = M100.J_hist; L100 = length(S100);
...
t20 = load('T_20_23-Mar-2021.mat');      te20 = t20.telapsed;
t25 = load('T_25_23-Mar-2021.mat');      te25 = t25.telapsed;
t50 = load('T_50_23-Mar-2021.mat');      te50 = t50.telapsed;
t100 = load('T_100_23-Mar-2021.mat');    te100 = t100.telapsed;
