...
x3 = in1(3,:);
x4 = in1(4,:);
l = ((x1-pi).*(x1./2.0-pi./2.0))./1.0e+2+u1.^2./2.0e+2+u2.^2./2.0e+2+x2.^2./2.0e+2+x3.^2./2.0e+2+x4.^2./2.0e+2;
if nargout > 1
    lx = [x1./1.0e+2-pi./1.0e+2;x2./1.0e+2;x3./1.0e+2;x4./1.0e+2];
end
if nargout > 2
